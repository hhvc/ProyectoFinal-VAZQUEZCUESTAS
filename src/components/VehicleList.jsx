...
//       try {
//         const vehiclesRef = collection(db, "automotores");
//         let queryFirestore = firestoreQuery(vehiclesRef);

//         // Apply filters
//         if (filterMarca)
//           queryFirestore = where(queryFirestore, "marca", "==", filterMarca);
//         if (filterModelo)
//           queryFirestore = where(queryFirestore, "modelo", "==", filterModelo);
//         if (filterCombustible)
//           queryFirestore = where(
//             queryFirestore,
//             "combustible",
//             "==",
//             filterCombustible
...
//         if (sortBy) {
//           const orderField = sortBy.includes("año") ? "año" : "precio";
//           const orderDirection = sortBy.includes("Asc") ? "asc" : "desc";
//           queryFirestore = orderBy(queryFirestore, orderField, orderDirection);
//         }

//         console.log("Query Firestore:", queryFirestore.toString());
//         const querySnapshot = await getDocs(queryFirestore);
//         const vehiclesData = querySnapshot.docs.map((doc) => ({
//           id: doc.id,
//           ...doc.data(),
...
//     fetchVehicles();
//   }, [db, filterMarca, filterModelo, filterCombustible, sortBy]);
...
//           {/* Agrega opciones de combustible según tu aplicación */}
//         </select>
...
//             </th>
//             <th>Patente/Dominio</th>
//             <th onClick={() => setSortBy("combustible")}>Combustible</th>
//             <th>Kms</th>
//             <th onClick={() => setSortBy("precio")}>
//               Precio{" "}
//               {sortBy === "precioAsc"
...
//           onChange={(e) => setFilterCombustible(e.target.value)}
//         >
//           <option value="">Filtrar por Combustible</option>
//           {/* Opciones para tipos de combustible */}
//         </select>
//       </div>
...
//             <th>Combustible</th>
//             <th>Kms</th>
//             <th onClick={() => setSortBy("precioAsc")}>
//               Precio {sortBy === "precioAsc" ? "↑" : sortBy === "precioDesc" ? "↓" : ""}
//             </th>
//             <th>Acciones</th>
//           </tr>
//         </thead>
...
//       // Aplicar filtros
//       if (filterMarca) query = query.where("marca", "==", filterMarca);
//       if (filterModelo) query = query.where("modelo", "==", filterModelo);
//       if (filterCombustible)
//         query = query.where("combustible", "==", filterCombustible);
